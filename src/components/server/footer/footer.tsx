          ...
          <div className='flex justify-between divide-x divide-stone-800 divide-opacity-40 max-sm:flex-col'>
            ...
            <FlexContainer title='Sobre nós'>
              <ul className='text-center'>
                <li>
                  <span> Sabor, saúde e sustentabilidade</span>
                </li>
                <li>
                  <span>
                    Cebolas frescas, receitas deliciosas e inspiração para a
                    vida
                  </span>
                </li>
                <li>
                  <span>
                    Vem conhecer a nossa horta e nossas receitas incríveis!
                  </span>
                </li>
                <li>
                  <span>
              ...
              <div className='flex flex-col gap-4'>
                ...
                <div>
                  <p className='text-center'>
                    Encontre nossos agricultores e ouça suas histórias de
                    paixão, dedicação e perseverança!
                  </p>
                </div>
              </div>
            </FlexContainer>

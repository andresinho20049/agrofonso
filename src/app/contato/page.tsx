...
const LinkContato = ({
  ...
  return (
    ...
    >
      <img alt='Instagram' src={imgSrc} className='h-8 w-8' />
      {label}
    </Link>
  );
};
  ...
  return (
    <section>
      <div className='bg-second-light dark:bg-second-dark'>
        <div className='mx-auto grid max-w-screen-2xl grid-cols-1 gap-8 py-20 lg:grid-cols-2'>
          <div className='w-full space-y-8 px-10'>
            <h1>Contate-nos</h1>
            <p className='text-center'>
              Sinta-se à vontade para entrar em contato conosco para quaisquer
              dúvidas ou assistência. Estamos aqui para ajudar!
            </p>
            ...
            <div className='grid grid-cols-2 justify-items-center space-x-8'>
              ...
              />
              <LinkContato
                href={'https://api.whatsapp.com/send?phone=557499734929'}
                label='Whatsapp'
        ...
        <div className='mx-auto flex max-w-screen-2xl justify-center p-8 align-middle'>
